...
<div class="container">
  ...
  <a href="<?php echo URL::to('inlinecrud/inlinecrud1'); ?>" class="btn btn-info ">Inline AJAX CRUD-1</a>
  <a href="<?php echo URL::to('inlinecrud/inlinecrud2'); ?>" class="btn btn-info ">Inline AJAX CRUD-2</a>
  <a href="<?php echo URL::to('user/logout'); ?>" class="btn btn-info ">Logout</a>
  <h3>Employee List</h3>
...
$(function(){
	...
	$("#showdata").on('click','.item_edit', function(){
	    ...
	    $("#my_form").attr("action","<?php echo url("employee/updateEmployee")?>");
	    $.ajax({
	      type: 'ajax',
	      method: 'get',
	      url: "<?php echo url("employee/editEmployee")?>",
	      data: {id:emp_id},
	      async: false,
	      dataType: 'json',
	...
	$("#showdata").on('click','.item_delete', function(){
	    ...
	    $("#btndelete").click(function(){
	      $.ajax({
	        ...
	        data: {id:emp_id},
	        async: false,
	        url: "<?php echo url("employee/deleteEmployee")?>",
	        dataType: 'json',
	        success: function(data){
	          // console.log(data);return false;
	...
	function showallEmployee(){
	    $.ajax({
	      type: 'get',
	      url: "<?php echo url("employee/getallEmployee")?>",
	      async: false,
	      dataType: 'json',
	      success: function(data){
	        console.log(data);
